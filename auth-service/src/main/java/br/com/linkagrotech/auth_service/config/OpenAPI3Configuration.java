...
@OpenAPIDefinition(servers = {
		@Server(url = "http://localhost:8080/auth") }, info = @Info(title = "Auth Service APIs", description = "This lists all the Auth Service API Calls. The Calls are OAuth2 secured, "
